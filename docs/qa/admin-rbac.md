...
| referral | OK | Spot-checked `referral.gam.view`, `referral.amb.view`, `referral.merchant.view`, etc. — backend uses the same short forms as nav; all seeded (20260707000000/…001). referral-rewards `referral.admin.*` (7) seeded 20260910000001. |
