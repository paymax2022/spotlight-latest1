    ...
    <Layout headerStyle={1} footerStyle={1} onePageNav={false} breadcrumbTitle={null} breadcrumbClassName={undefined} breadcrumbPadding={undefined}>
              ...
              <div key={sector.title} className="overflow-hidden rounded-xl border border-[#e2cfad] bg-white/82 shadow-[0_14px_30px_rgba(64,42,18,0.12)]">
                <div className="relative">
                  <div className="h-32 overflow-hidden">
                    ...
                    <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-black/10 via-transparent to-[#fbf5e9]/30" />
                  </div>
                  <div className="absolute left-1/2 top-32 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border-[3px] border-[#d5a13b] bg-[#04391f] text-[#f0c865] shadow-[0_10px_20px_rgba(3,35,20,0.22)]">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        <div className="rounded-2xl border border-[rgba(245,240,232,0.07)] bg-[#161616] p-7 md:p-10">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-foreground mt-2">Activation sssssTouchpoints</h2>
