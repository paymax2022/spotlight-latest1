          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-3 max-w-md">
                <div className="glass-card rounded-md p-3">
                  <p className="text-xs text-foreground/60">Audition in</p>
                ...
                <div className="glass-card rounded-md p-3">
                  ...
                  <p className="text-2xl font-display text-foreground">60 Talents</p>
                        <p className="text-2xl font-display text-foreground">60 Days Bootcamp</p>
                </div>
              </div>
            ...
            <div className="glass-card rounded-md p-3 md:p-4">
              <img
                ...
                className="w-full h-[260px] md:h-[360px] object-contain rounded-md"
              />
            </div>
          </div>
        </div>
