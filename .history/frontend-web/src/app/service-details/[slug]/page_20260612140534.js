...
export default function ServiceDetailBySlug({ params }) {
  ...
  return (
    <Layout headerStyle={1} footerStyle={2} breadcrumbTitle={null}>
      <section className="position-relative overflow-hidden" style={{ minHeight: '430px' }}>
        <div className="position-absolute top-0 start-0 w-100 h-100">
          <img
            src={program.bannerImage || program.heroImage || '/assets/img/shape/banner2.png'}
                    ...
                    <div className="details-video-items">
                      {!hideProgramMedia && (
                        <div className="video-thumb">
                          <img src="/assets/img/shape/open-mic4.png" alt="Spotlight program media" />
                        </div>
                      )}
