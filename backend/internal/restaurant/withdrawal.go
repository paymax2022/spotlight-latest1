...
// WithTiers attaches the fail-closed tier-limit gate used before the wallet debit.
// Required for the withdrawal money path (RequestWithdrawal refuses without it).
