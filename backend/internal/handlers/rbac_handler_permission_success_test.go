...
func (rbacHandlerTestService) UpdateRole(string, domain.Role) (domain.Role, error) {
	return domain.Role{}, nil
}
func (rbacHandlerTestService) CloneRole(string, string, string) (domain.Role, error) {
	return domain.Role{}, nil
}
...
func (rbacHandlerTestService) CreatePermission(p domain.Permission) (domain.Permission, error) {
	p.ID = "perm-created"
	return p, nil
}
...
func (rbacHandlerTestService) GetPermissionMatrix() (services.PermissionMatrix, error) {
...
func (rbacHandlerTestService) AssignRoleToUser(string, string, string, string, string) error {
	return nil
}
...
func (rbacHandlerTestService) GetAdminUser(string) (domain.AdminUser, error) {
	return domain.AdminUser{}, nil
}
func (rbacHandlerTestService) UpdateAdminUser(string, map[string]any) (domain.AdminUser, error) {
	return domain.AdminUser{}, nil
}
