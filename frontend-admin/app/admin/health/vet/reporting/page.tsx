        ...
        {data && (
          <>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: '0.75rem', marginBottom: '1.25rem' }}>
              ...
              <Kpi label="SOS routed" value={data.sos_routed.toLocaleString('en-NG')} sub="HL-11 in-person" accent={data.sos_routed > 0 ? colors.danger : undefined} />
                    ...
                    <div key={m.month} style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                      ...
                      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 3 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                          ...
                          <span style={{ fontSize: '0.7rem', color: colors.muted, whiteSpace: 'nowrap' }}>{formatNaira(m.net_kobo)} · {m.appointments.toLocaleString('en-NG')} appts</span>
                        </div>
                      </div>
                    </div>
                  );
