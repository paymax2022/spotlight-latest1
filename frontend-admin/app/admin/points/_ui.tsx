...
// Points ops console shares the savings/_ui light-card primitives and adds the
...
export function PointsTabs({ active }: { active: string }) {
  const tabs: Tab[] = [
    { href: '/admin/points/dashboard', label: 'Overview', key: 'overview' },
    { href: '/admin/points/ledger', label: 'Ledger', key: 'ledger' },
    { href: '/admin/points/balances', label: 'Balances', key: 'balances' },
  ];
  return (
