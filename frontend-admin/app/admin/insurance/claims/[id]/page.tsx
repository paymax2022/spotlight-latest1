          ...
          <>
            ...
            <Card title="Key facts" right={<Badge status={data.state} />}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '1rem' }}>
                ...
                <Fact k="Policy" v={<Link href={`/admin/insurance/policies/${data.policy_id}`} style={{ color: '#340075', fontWeight: 600, textDecoration: 'none' }}>{data.policy_id}</Link>} />
            ...
            <Card title="Evidence">
              {data.evidence.length === 0 ? (
                <p style={{ color: '#6b7280' }}>No evidence uploaded for this claim.</p>
              ) : (
                <>
