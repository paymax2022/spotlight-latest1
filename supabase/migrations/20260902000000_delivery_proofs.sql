...
CREATE TABLE IF NOT EXISTS pharmacy_delivery_proofs (
  ...
  captured_by UUID NOT NULL,
    COMMENT 'driver/courier user_id who captured the proof',
  captured_at TIMESTAMPTZ NOT NULL DEFAULT now(),
  verified_at TIMESTAMPTZ,
    COMMENT 'null until verified by a ProofVerifier seam (e.g. OTP validation, signature OCR)',
  note TEXT,
...
CREATE INDEX idx_pharmacy_delivery_proofs_order_id
  ON pharmacy_delivery_proofs (order_id);

CREATE INDEX idx_pharmacy_delivery_proofs_captured_by
