...
export default function LandlordSignupScreen() {
  ...
  const handleSubmit = async () => {
    setError('');
    if (!fullName || !email || !phone || !numProperties || !password) {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Landlord / Property Owner</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <AppInput label="Number of Properties" value={numProperties} onChangeText={setNumProperties} keyboardType="number-pad" placeholder="How many properties do you own?" />
