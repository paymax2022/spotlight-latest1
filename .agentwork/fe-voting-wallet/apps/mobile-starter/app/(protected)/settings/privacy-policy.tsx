...
const SECTIONS = ['1. Information We Collect','2. How We Use Your Information','3. Data Sharing','4. Data Security','5. Your Rights','6. Cookies and Tracking','7. Children\'s Privacy','8. Contact Us'];
...
export default function PrivacyPolicy() {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}><Pressable style={styles.backBtn} onPress={() => router.back()}><Ionicons name="arrow-back" size={22} color="#fff" /></Pressable><Text style={styles.headerTitle}>Privacy Policy</Text><View style={{ width: 38 }} /></View>
