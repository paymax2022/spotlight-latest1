...
export default function HomeownerSignupScreen() {
  ...
  const handleSubmit = async () => {
    setError('');
    if (!fullName || !email || !phone || !propertyAddress || !blockUnit || !password) {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Homeowner Registration</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <AppInput label="Property Address" value={propertyAddress} onChangeText={setPropertyAddress} placeholder="Full property address" />
        <AppInput label="Block / Unit Number" value={blockUnit} onChangeText={setBlockUnit} placeholder="e.g. Block A, Unit 4" />
