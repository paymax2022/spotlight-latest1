                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                <div className="single-footer-widget">
                                    ...
                                    <div className="footer-content">
                                        <p>
                                           Premium platform to own transformation, create desire,
                                            drive product trial, activate retail sales, 
                                            grow e-commerce traffic, build social proof, and 
                                            convert beauty influence into measurable consumer growth.
                                        </p>
                                        <div className="social-icon d-flex align-items-center">
                                                <Link href="https://www.instagram.com/spotlighttalentng/"><i className="fab fa-instagram" /></Link>
