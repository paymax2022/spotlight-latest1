...
export const OPEN_MIC_COUNTRIES = ['Nigeria'];

export const OPEN_MIC_STATES = NIGERIA_STATES;

export const OPEN_MIC_LGAS_BY_STATE: Record<string, string[]> = {
  ...
  Ebonyi: ['Abakaliki', 'Afikpo', 'Ebonyi', 'Ezza North', 'Ezza South', 'Ikwo', 'Ishielu', 'Ivo', 'Izzi', 'Ohaozara', 'Ohaukwu', 'Onicha'],
...
export function getOpenMicLgaOptions(state: string) {
  if (!state) return [];
  return OPEN_MIC_LGAS_BY_STATE[state] || [];
}
