...
export default function VisitorDisabledScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Visitor Disabled</Text>
        <View style={{ width: 38 }} />
      </View>
      <View style={styles.container}>
        <View style={styles.lockOverlay}>
          <Ionicons name="person-circle-outline" size={60} color={colors.neutral.placeholder} />
          <View style={styles.lockBadge}><Ionicons name="lock-closed" size={28} color={colors.secondary.red} /></View>
        </View>
        <Text style={styles.title}>Visitor Access Disabled</Text>
        <Text style={styles.sub}>Your Visitor access is disabled until outstanding dues are settled.</Text>
