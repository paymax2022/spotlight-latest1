...
export default function Season2Page() {
  return (
    <Layout headerStyle={1} footerStyle={1} onePageNav={false} breadcrumbTitle={null} breadcrumbClassName={undefined} breadcrumbPadding={undefined}>
      <PageHero label="Season 2" title="Spotlight Season ss2: From Audition to Stardom" subtitle="20-State Auditions. 60 Contestants. 60-Day Bootcamp. Public Voting. Reality TV. Grand Finale. Spotlight Season 2 is a national youth entertainment and empowerment campaign designed to discover, develop, promote, and connect emerging talents through auditions, bootcamp training, reality TV exposure, public voting, brand partnerships, and post-show career opportunities." ctas={[{ label: 'Apply Now', href: '/apply' }, { label: 'Become a Sponsor', href: '/sponsor', style: 'outline' }, { label: 'View Voting Process', href: '/voting', style: 'outline' }]} heroImage={{ src: '/assets/img/shape/flyer3.png', alt: 'Spotlight Season 2 campaign visual' }} />
