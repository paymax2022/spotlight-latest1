    ...
    return (
        <section className="pricing-section section-bg fix section-padding">
            ...
            <div className="right-shape">
                <img src="/assets/img/shape/yvonne-1.jpg" alt="shape-img" />
            </div>
            <div className="container">
                ...
                <div className="row g-4">
                    <div className="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                        <div className="project-items">
                            <div className="project-image">
                                <img src="/assets/img/slider/women.jpeg" alt="Spotlight gallery image one" />
                                <div className="project-content">
                                    <p>Live Showcase</p>
                                    <h4>
                                        <Link href="/media">Women In Entertainment Spotlight</Link>
                                    </h4>
                    ...
                    <div className="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                        <div className="project-items">
                            <div className="project-image">
                                <img src="/assets/img/slider/FMACCE.png" alt="Spotlight gallery image two" />
                                <div className="project-content">
                    ...
                    <div className="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                        <div className="project-items">
                            <div className="project-image">
                                <img src="/assets/img/slider/wazobia.jpg" alt="Spotlight gallery image three" />
                                <div className="project-content">
                                    <p>Broadcast Reach</p>
                                    <h4>
