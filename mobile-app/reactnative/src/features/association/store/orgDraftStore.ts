...
import type { OrgDraft, DraftChapter, DraftCategory, DraftCommittee } from '../types/orgDraft.types';
...
export const useOrgDraft = create<OrgDraftState>((set) => ({
  ...
  reset: () => set({ draft: { ...emptyDraft, chapters: [], committees: [], categories: [], restrictions: { ...emptyDraft.restrictions } } }),
}));
