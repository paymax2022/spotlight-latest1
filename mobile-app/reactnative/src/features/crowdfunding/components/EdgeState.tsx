...
/**
 * Full-screen edge/error state (no internet, maintenance, session expired, …).
 * Built on the same tokens as StateView but as a standalone full-page surface
 * with up to two actions.
 */
export default function EdgeState({ icon, title, message, tone = 'neutral', primaryLabel, onPrimary, secondaryLabel, onSecondary }: Props) {
