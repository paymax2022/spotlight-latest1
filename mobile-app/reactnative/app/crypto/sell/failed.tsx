...
export default function SellFailedScreen() {
  ...
  const retry = () =>
    router.replace({ pathname: '/crypto/sell/review', params: { symbol: p.symbol, basis: p.basis, amount: p.amount } });
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.center}>
        ...
        <Text style={styles.note}>Your crypto holding is unchanged.</Text>
      </View>
