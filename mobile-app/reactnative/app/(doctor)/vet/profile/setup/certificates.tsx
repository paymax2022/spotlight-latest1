...
export default function VetCertificatesScreen() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      router.push('/(doctor)/vet/profile/setup/affiliations');
    } catch { /* surfaced */ }
  };
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <WizardProgress current={6} total={10} label="Veterinary certificates" />

        <SectionCard title="Professional certificates" style={styles.card}>
          <Text style={styles.hint}>Add any additional veterinary certificates or fellowships (optional).</Text>
