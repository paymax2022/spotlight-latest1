  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.center}>
        ...
        {marketClosed ? (
          <Text style={styles.note}>Place a limit order to queue your sale — it executes when the market next opens.</Text>
        ) : (
          <Text style={styles.note}>No shares were sold. Your holdings are unchanged.</Text>
        )}
      </View>
