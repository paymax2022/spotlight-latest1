...
export default function StockBuyProcessingScreen() {
  ...
  useEffect(() => {
    ...
    place.mutate(
      {
        assetId: a.id, symbol: a.symbol, side: 'buy', orderType,
  ...
  if (asset.isError) {
    return (
      <SafeAreaView style={styles.safe}>
        <StateView kind="error" title="Something went wrong" message="We couldn't start your order. No funds were debited." actionLabel="Back" onAction={() => router.replace('/stocks')} />
      </SafeAreaView>
    );
  }
