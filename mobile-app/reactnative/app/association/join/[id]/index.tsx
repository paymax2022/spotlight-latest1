...
export default function JoinOrganisation() {
  ...
  // Plenty of associations have no chapter structure at all — this one (0 chapters)
  // is why the field is conditional rather than always-on.
  ...
  // join: the field offered no options, so `chapter` stayed empty, `valid` stayed false
  // and Submit never enabled — with the error pointing at a dropdown that had nothing in it.
