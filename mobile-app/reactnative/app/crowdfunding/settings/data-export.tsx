  ...
  if (requested) {
    return (
      <SafeAreaView style={styles.safe} edges={['top']}>
        ...
        <StateView kind="empty" icon="MailCheck" title="Request received" message="We'll email a downloadable copy of your data to your registered address within 48 hours." actionLabel="Done" onAction={() => router.back()} />
      </SafeAreaView>
    );
  }
