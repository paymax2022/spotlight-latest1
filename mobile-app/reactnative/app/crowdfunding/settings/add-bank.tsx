  ...
  if (done) {
    return (
      <SafeAreaView style={styles.safe} edges={['top']}>
        ...
        <StateView kind="empty" icon="BadgeCheck" title="Bank account verified" message="Your bank account has been added and verified for withdrawals." actionLabel="Done" onAction={() => router.back()} />
      </SafeAreaView>
    );
  }
