    ...
    <section className="max-w-5xl mx-auto px-2 md:px-4 pb-6">
      ...
      <div className="glass-card rounded-md p-4 mt-4">
        <p className="text-sm text-foreground/80">
          Use the API endpoint <code>/api/admin/open-mic/contests/{contest.id}</code> (PATCH) to update timeline, venue,
          status, voting config, finalists target, and monthly settings.
        </p>
