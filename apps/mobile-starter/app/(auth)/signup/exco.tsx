...
const POSITIONS = ['Chairman', 'Secretary', 'Treasurer', 'PRO', 'Member'];

export default function ExcoSignupScreen() {
  ...
  const handleSubmit = async () => {
    setError('');
    if (!fullName || !email || !phone || !position || !estateName || !password) {
      setError('Please fill in all fields and select your position.');
      return;
    }
    setLoading(true);
    try {
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Exco / Association Officer</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View>
          <AppText variant="bodyMedium" style={styles.sectionLabel}>Position</AppText>
